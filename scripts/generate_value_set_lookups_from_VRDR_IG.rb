...
codesystems = {
    ...
    "http://terminology.hl7.org/CodeSystem/v3-MaritalStatus" => "VR.CodeSystems.PH_MaritalStatus_HL7_2x",
    "http://hl7.org/fhir/administrative-gender" => "VR.CodeSystems.VRDRAdministrativeGender",
    "http://terminology.hl7.org/CodeSystem/v3-EducationLevel" => "VR.CodeSystems.EducationLevel",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-filing-format-cs" => "VR.CodeSystems.FilingFormat",
    "http://terminology.hl7.org/CodeSystem/v2-0360" => "VR.CodeSystems.DegreeLicenceAndCertificate",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-pregnancy-status-cs" => "VR.CodeSystems.PregnancyStatus",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/CodeSystem-death-pregnancy-status" =>"VR.CodeSystems.DeathPregnancyStatus",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-replace-status-cs" => "VR.CodeSystems.ReplaceStatus",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-missing-value-reason-cs" => "VR.CodeSystems.MissingValueReason",
    "http://unitsofmeasure.org" => "VR.CodeSystems.UnitsOfMeasure",
    "http://terminology.hl7.org/CodeSystem/v2-0136" => "VR.CodeSystems.YesNo",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-activity-at-time-of-death-cs" => "VR.CodeSystems.ActivityAtTimeOfDeath",
    "http://loinc.org" => "VR.CodeSystems.LOINC",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-race-code-cs" => "VR.CodeSystems.RaceCode",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-race-recode-40-cs" => "VR.CodeSystems.RaceRecode40",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-hispanic-origin-cs" => "VR.CodeSystems.HispanicOrigin",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-intentional-reject-cs" => "VR.CodeSystems.IntentionalReject",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-system-reject-cs" => "VR.CodeSystems.SystemReject",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-transax-conversion-cs" => "VR.CodeSystems.TransaxConversion",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-country-code-cs" => "VR.CodeSystems.CountryCode",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-canadian-provinces-cs" => "VR.CodeSystems.CanadianProvinces",
    "http://hl7.org/fhir/us/vr-common-library/CodeSystem/CodeSystem-vr-edit-flags" => "VR.CodeSystems.VRCLEditFlags",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-date-of-death-determination-methods-cs" => "VR.CodeSystems.DateOfDeathDeterminationMethods",
    "http://hl7.org/fhir/us/vrdr/CodeSystem/vrdr-system-placeofinjury-cs" => "VR.CodeSystems.PlaceOfInjury"
}
...
valuesets = {
    ...
    "ValueSet-vrdr-date-of-death-determination-methods-vs.json" =>"DateOfDeathDeterminationMethods",
    "ValueSet-vrdr-death-certification-event-vs.json" => "DeathCertificationEvent",
    "ValueSet-vrdr-death-pregnancy-status-vs.json" => "DeathPregnancyStatus",
    ...
    "ValueSet-vrdr-place-of-injury-other-vs.json" => "PlaceOfInjuryOther",
    ...
    "ValueSet-vrdr-system-reject-vs.json" => "SystemReject", 
