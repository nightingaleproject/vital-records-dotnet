       ...
       // [FHIRSubject(FHIRSubject.Subject.Newborn)]
        public Tuple<string, string>[] MotherRace
        {
            get
            {
                ...
                Observation obs = GetOrCreateObservation("inputraceandethnicityMother", CodeSystems.InputRaceAndEthnicityPerson, "Input Race and Ethnicity Person", VR.ProfileURL.InputRaceAndEthnicity, "inputraceandethnicityMother");
        ...
        public Tuple<string, string>[] FatherRace
        {
            get
            {
                ...
                Observation obs = GetOrCreateObservation("inputraceandethnicityFather", CodeSystems.InputRaceAndEthnicityPerson, "Input Race and Ethnicity Person", VR.ProfileURL.InputRaceAndEthnicity, "inputraceandethnicityFather");
