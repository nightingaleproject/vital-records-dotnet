...
namespace BFDR
{
    public partial class FetalDeathRecord : BirthOrFetalDeathRecord
    {
        ...
        /// <summary>Child's Year of Delivery.</summary>
        ...
        /// <para>// Getter:</para>
        /// <para>Console.WriteLine($"Child Year of Delivery: {ExampleDeliveryRecord.DeliveryYear}");</para>
        /// </example>
        [Property("DeliveryYear", Property.Types.Int32, "Child Demographics", "Child's Year of Delivery.", false, VR.IGURL.Child, true, 14)]
        ...
        public int? DeliveryYear
        {
            ...
            set
            {
                ...
                string time = this.DeliveryTime;
                Date newDate = SetYear(value, Child.BirthDateElement, DeliveryMonth, DeliveryDay);
                if (newDate != null)
                {
        ...
        private void SetNewlyCompletedDate(DateTime completeDate)
        {
            ...
            if (DeliveryTime != null && DeliveryTime != "temp-unknown")
            {
                Time time = new Time(DeliveryTime);
        ...
        /// <summary>Child's Month of Delivery.</summary>
        /// <value>the child's month of birth, or -1 if explicitly unknown, or null if never specified</value>
        /// <example>
        /// <para>// Setter:</para>
        /// <para>ExampleBirthRecord.DeliveryMonth = 11;</para>
        /// <para>// Getter:</para>
        /// <para>Console.WriteLine($"Child Month of Delivery: {ExampleBirthRecord.DeliveryMonth}");</para>
        /// </example>
        [Property("DeliveryMonth", Property.Types.Int32, "Child Demographics", "Child's Month of Delivery.", false, VR.IGURL.Child, true, 14)]
        [FHIRPath("Bundle.entry.resource.where($this is Patient).birthDate", "")]
        public int? DeliveryMonth
        {
            ...
            set
            {
                ...
                Date newDate = SetMonth(value, Child.BirthDateElement, DeliveryYear, DeliveryDay);
                if (newDate != null)
                {
                    Child.BirthDateElement = newDate;
                }
        ...
        /// <summary>Child's Day of Delivery.</summary>
        /// <value>the child's day of birth, or -1 if explicitly unknown, or null if never specified</value>
        /// <example>
        /// <para>// Setter:</para>
        /// <para>ExampleBirthRecord.DeliveryDay = 11;</para>
        /// <para>// Getter:</para>
        /// <para>Console.WriteLine($"Child Day of Delivery: {ExampleBirthRecord.DeliveryDay}");</para>
        /// </example>
        [Property("DeliveryDay", Property.Types.Int32, "Child Demographics", "Child's Day of Delivery.", false, VR.IGURL.Child, true, 14)]
        ...
        public int? DeliveryDay
        {
            ...
            set
            {
                ...
                Date newDate = SetDay(value, Child.BirthDateElement, DeliveryYear, DeliveryMonth);
                if (newDate != null)
                {
                    Child.BirthDateElement = newDate;
                }
        ...
        /// <summary>Child's Time of Delivery.</summary>
        /// <value>the child's time of birth.</value>
        /// <example>
        /// <para>// Setter:</para>
        /// <para>ExampleBirthRecord.DeliveryTime = 11;</para>
        /// <para>// Getter:</para>
        /// <para>Console.WriteLine($"Child Time of Delivery: {ExampleBirthRecord.DeliveryTime}");</para>
        /// </example>
        [Property("DeliveryTime", Property.Types.String, "Child Demographics", "Child's Time of Delivery.", true, VR.IGURL.Child, true, 14)]
        ...
        public string DeliveryTime
        {
            ...
            set
            {
                ...
                if (value != "-1" && DateIsComplete(this.DateOfDelivery))
                {
                    FhirDateTime dateTime = new FhirDateTime(this.DateOfDelivery + "T" + value);
                    Child.BirthDateElement.SetExtension(VR.ExtensionURL.PatientBirthTime, dateTime);
                    return;
                }
        ...
        /// <summary>Child's Date of Delivery.</summary>
        /// <value>the child's date of birth</value>
        /// <example>
        /// <para>// Setter:</para>
        /// <para>ExampleBirthRecord.DateOfDelivery = "1940-02-19";</para>
        /// <para>// Getter:</para>
        /// <para>Console.WriteLine($"Child Date of Delivery: {ExampleBirthRecord.DateOfDelivery}");</para>
        /// </example>
        [Property("Date Of Delivery", Property.Types.String, "Child Demographics", "Child's Date of Delivery.", true, VR.IGURL.Child, true, 14)]
        [FHIRPath("Bundle.entry.resource.where($this is Patient).birthDate", "")]
