...
namespace BFDR
{
    ...
    public partial class NatalityRecord
    {
        ...
        private void SetNewlyCompletedDate(DateTime completeDate)
        {
            ...
            if (GetBirthTime() != null && GetBirthTime() != "temp-unknown")
            {
                Time time = new Time(GetBirthTime());
        ...
        /// <summary>
        ///  Setter method for child or decedent fetus birth/delivery time.
        /// </summary>
        /// <param name="value">The birth time.</param>
        ...
        /// <example>
        /// <para>// Setter:</para>
        /// <para>ExampleBirthRecord.PatientFetalDeath = true;</para>
        /// <para>// Getter:</para>
        /// <para>Console.WriteLine($"Patient Fetal Death: {ExampleBirthRecord.PatientFetalDeath}");</para>
        /// </example>
