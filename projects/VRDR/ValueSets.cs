...
namespace VRDR
{
    ...
    public static class ValueSets
    {
        ...
        public static class AdministrativeGender {
            /// <summary> Codes </summary>
            public static string[,] Codes = {
                { "male", "Male", VR.CodeSystems.AdministrativeGender },
                { "female", "Female", VR.CodeSystems.AdministrativeGender },
                { "unknown", "unknown", VR.CodeSystems.AdministrativeGender }
            };
        ...
        public static class EditBypass01 {
            /// <summary> Codes </summary>
            public static string[,] Codes = {
                { "0", "Edit Passed", VR.CodeSystems.BypassEditFlag },
                { "1", "Edit Failed, Data Queried, and Verified", VR.CodeSystems.BypassEditFlag }
            };
        ...
        public static class EditBypass012 {
            ...
            public static string[,] Codes = {
                { "0", "Edit Passed", VR.CodeSystems.BypassEditFlag },
                { "1", "Edit Failed, Data Queried, and Verified", VR.CodeSystems.BypassEditFlag },
                { "2", "Edit Failed, Data Queried, but not Verified", VR.CodeSystems.BypassEditFlag }
            };
            /// <summary> Edit_Passed </summary>
            public static string  Edit_Passed = "0";
            /// <summary> Edit_Failed_Data_Queried_And_Verified </summary>
        ...
        public static class EditBypass01234 {
            ...
            public static string[,] Codes = {
                ...
                { "1", "Edit Failed, Data Queried, and Verified", VR.CodeSystems.BypassEditFlag },
                { "2", "Edit Failed, Data Queried, but not Verified", VR.CodeSystems.BypassEditFlag },
                { "3", "Edit Failed, Review Needed", VR.CodeSystems.BypassEditFlag },
                { "4", "Edit Failed, Query Needed", VR.CodeSystems.BypassEditFlag }
            };
            /// <summary> Edit_Passed </summary>
            public static string  Edit_Passed = "0";
            /// <summary> Edit_Failed_Data_Queried_And_Verified </summary>
        ...
        public static class PregnancyStatus {
            /// <summary> Codes </summary>
            public static string[,] Codes = {
                { "1", "Not pregnant within past year", VR.CodeSystems.PregnancyStatus },
                { "2", "Pregnant at time of death", VR.CodeSystems.PregnancyStatus },
                { "3", "Not pregnant, but pregnant within 42 days of death", VR.CodeSystems.PregnancyStatus },
