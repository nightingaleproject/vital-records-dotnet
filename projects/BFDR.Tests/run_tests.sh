...
echo "* dotnet test BFDR.Tests/BirthRecord.Tests.csproj"
dotnet test BFDR.Tests/BirthRecord.Tests.csproj
...
dotnet run --project BFDR.CLI json2json BFDR.Tests/fixtures/json/BasicBirthRecord.json > /dev/null
